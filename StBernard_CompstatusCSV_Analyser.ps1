...
.EXAMPLE
    ...
    .\StBernard_CompstatusCSV_Analyser.ps1
...
Write-Host "  |  StBernard_CompstatusCSV_Analyser |" -ForegroundColor Cyan
Write-Host "  +-----------------------------------------------------------------------+" -ForegroundColor Cyan
Write-Host ''
...
/* StBernard logo */
.sbh-logo { height:48px; width:48px; border-radius:6px; margin-right:12px; vertical-align:middle; }
.sbh-header-wrap { display:flex; align-items:center; margin-bottom:4px; }
...
<header>
  <!-- StBernard_CompstatusCSV_Analyser logo
       Image: Freepik Premium resource. Free users must add attribution: "Image by pch.vector on Freepik"
       Premium subscribers may use without attribution. -->
  <div class="logo"><img src='data:image/jpeg;base64,' alt='StBernard' style='height:52px;width:52px;border-radius:8px;display:block;'></div>
  <div>
    <h1>$fullTitle <span class="mode-pill">$modeLabel</span></h1>
    <div class="meta">Source: <code>$fileLabel</code> &nbsp;|&nbsp; Generated: $reportDate &nbsp;|&nbsp; StBernard_CompstatusCSV_Analyser &#8212; SharpHound Collection Diagnostics</div>
  </div>
</header>
...
$outFileName = "StBernard_CompstatusCSV_Analyser_Report_${modeTag}_${timestamp}.html"
...
Write-Host '  |  StBernard_CompstatusCSV_Analyser - Report written successfully             |' -ForegroundColor Green
Write-Host '  +-------------------------------------------------------------+' -ForegroundColor Green
...
if ($ExportOpenGraph) {
    ...
    $ogFile      = "StBernard_CompstatusCSV_Analyser_OG_${ogTimestamp}.json"
    ...
    Write-Host '  |  StBernard_CompstatusCSV_Analyser - OpenGraph Export                        |' -ForegroundColor Magenta
    Write-Host '  +-------------------------------------------------------------+' -ForegroundColor Magenta
    Write-Host ''
    ...
    Write-Host ''
    Write-Host '  StBernard_CompstatusCSV_Analyser EXPORT SUMMARY' -ForegroundColor Magenta
    Write-Host "    Project            : StBernard_CompstatusCSV_Analyser"
    ...
    if ($UploadIcons) {
        ...
        if (-not $BHEUrl -or -not $hasAuth) {
            ...
            Write-Host '  |  StBernard_CompstatusCSV_Analyser - Uploading Icons             |' -ForegroundColor Blue
            Write-Host '  +-------------------------------------------------------------+' -ForegroundColor Blue
            Write-Host ''
